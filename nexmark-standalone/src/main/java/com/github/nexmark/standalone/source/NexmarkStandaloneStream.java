...
public class NexmarkStandaloneStream {

	public NexmarkStandaloneStream() {}

	/** Method is used to generate data stream.
	 *  Parameters regarding propertions and event count can be edited below
	 */
