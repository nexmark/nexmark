-- -------------------------------------------------------------------------------------------------
-- Query 2: Longest period of time for average price (Not in original suite)
-- -------------------------------------------------------------------------------------------------
-- Finds the longest period of time for which the average price of a bidder did not go below certain threshold.
-- Illustrates Aggregations and  a AFTER MATCH strategy SKIP TO NEXT ROW in MATCH_RECOGNIZE.
-- -------------------------------------------------------------------------------------------------
